#!/usr/bin/env python3
"""
Working Financial Text-to-SQL Fine-tuning for Apple Silicon
...
def main():
    logger.info("=" * 60)
    logger.info("Working Financial Text-to-SQL Fine-tuning")
    ...
    try:
        ...
        training_file = "working_training_data.json"
        if os.path.exists(training_file):
            ...
            train_data = generate_training_data(500)  # Smaller dataset for faster training
        ...
        training_args = TrainingArguments(
            ...
            warmup_steps=5,
            max_steps=100,  # Fewer steps for faster training
            learning_rate=1e-4,
            fp16=False,
            bf16=False,
            logging_steps=5,
        ...
        output_dir = "./working_financial_model"
