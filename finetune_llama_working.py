#!/usr/bin/env python3
"""
Working Llama 3.1 8B Fine-tuning for Apple Silicon
Uses standard transformers without Unsloth
"""
...
def setup_model_and_tokenizer():
    """Load Llama model using standard transformers for Apple Silicon"""
    try:
        from transformers import AutoModelForCausalLM, AutoTokenizer
        from peft import LoraConfig, get_peft_model, prepare_model_for_kbit_training
        
        logger.info("Loading Llama 3.1 8B for Apple Silicon...")
        
        # Try different Llama models in order of preference
        model_options = [
            "NousResearch/Llama-2-7b-chat-hf",  # Often available without auth
            "meta-llama/Meta-Llama-3.1-8B-Instruct",  # Original target
...
def main():
    logger.info("=" * 60)
    logger.info("Working Llama 3.1 8B Financial Text-to-SQL Fine-tuning")
    logger.info("Apple Silicon Compatible - Standard Transformers")
    logger.info("=" * 60)
    ...
    try:
        ...
        training_file = "llama_working_training_data.json"
        ...
        training_args = TrainingArguments(
            ...
            seed=3407,
            output_dir="./llama_working_outputs",
            save_strategy="steps",
            save_steps=50,
            report_to="none",
        ...
        output_dir = "./llama_working_model"
