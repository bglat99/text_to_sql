"""
Simplified fine-tuning script for Apple Silicon compatibility
"""
...
def train_model(model, tokenizer, train_dataset, test_dataset, training_args):
    ...
    trainer = SFTTrainer(
        ...
        text_column="text",
        max_seq_length=512,  # Reduced for smaller model
        args=training_args,
    )
...
def save_model(model, tokenizer, output_dir="financial_sql_model_simple"):
    """
...
def main():
    ...
    """
    print("=" * 60)
    print("Financial Text-to-SQL Fine-tuning (Apple Silicon)")
    print("=" * 60)
    ...
    print("=" * 60)
    print(f"Model saved to: financial_sql_model_simple/")
