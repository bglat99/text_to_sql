#!/usr/bin/env python3
"""
Final Working Financial Text-to-SQL Fine-tuning for Apple Silicon
Properly handles data collation and tokenization
"""
...
def generate_training_data(n_samples: int = 300) -> List[Dict]:
...
def main():
    logger.info("=" * 60)
    logger.info("Final Working Financial Text-to-SQL Fine-tuning")
    ...
    try:
        ...
        training_file = "final_training_data.json"
        if os.path.exists(training_file):
            ...
            train_data = generate_training_data(300)  # Smaller dataset for faster training
        ...
        output_dir = "./final_financial_model"
